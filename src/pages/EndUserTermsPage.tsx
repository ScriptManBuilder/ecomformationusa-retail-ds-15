      ...
      <LegalPageContainer>
        ...
        <LegalContent>
          <LegalSection>
            ...
            <LegalParagraph>
              We serve only retail clients. These End-User Terms of Service ("End-User Terms") govern your use of services provided by 
              {process.env.REACT_APP_COMPANY_NAME} when you make a purchase through our retail offers.
            </LegalParagraph>
            <LegalParagraph>
          ...
          <LegalSection>
            ...
            <LegalParagraph>
              {process.env.REACT_APP_COMPANY_NAME} provides customer payment assistance services for retail purchases. 
              Our services include:
            </LegalParagraph>
            <LegalList>
              <LegalListItem>
                <strong>Payment Processing:</strong> Secure processing of payments for products purchased in retail stores
              </LegalListItem>
              <LegalListItem>
              ...
              <LegalListItem>
                <strong>Customer Service:</strong> Support for questions about your retail purchase
              </LegalListItem>
              <LegalListItem>
            ...
            <LegalParagraph style={{ marginTop: '1rem' }}>
              We process payments for products you purchased at retail stores. The products and services are provided 
